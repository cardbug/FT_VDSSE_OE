...
::grpc::ClientReader< ::FT_VDSSE::SearchReply>* RPC::Stub::searchRaw(::grpc::ClientContext* context, const ::FT_VDSSE::SearchRequestMessage& request) {
  return ::grpc_impl::internal::ClientReaderFactory< ::FT_VDSSE::SearchReply>::Create(channel_.get(), rpcmethod_search_, context, request);
}

void RPC::Stub::experimental_async::search(::grpc::ClientContext* context, ::FT_VDSSE::SearchRequestMessage* request, ::grpc::experimental::ClientReadReactor< ::FT_VDSSE::SearchReply>* reactor) {
  ::grpc_impl::internal::ClientCallbackReaderFactory< ::FT_VDSSE::SearchReply>::Create(stub_->channel_.get(), stub_->rpcmethod_search_, context, request, reactor);
}
...
::grpc::ClientAsyncReader< ::FT_VDSSE::SearchReply>* RPC::Stub::AsyncsearchRaw(::grpc::ClientContext* context, const ::FT_VDSSE::SearchRequestMessage& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::FT_VDSSE::SearchReply>::Create(channel_.get(), cq, rpcmethod_search_, context, request, true, tag);
}
...
::grpc::ClientAsyncReader< ::FT_VDSSE::SearchReply>* RPC::Stub::PrepareAsyncsearchRaw(::grpc::ClientContext* context, const ::FT_VDSSE::SearchRequestMessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::FT_VDSSE::SearchReply>::Create(channel_.get(), cq, rpcmethod_search_, context, request, false, nullptr);
}
...
void RPC::Stub::experimental_async::update(::grpc::ClientContext* context, const ::FT_VDSSE::UpdateRequestMessage* request, ::FT_VDSSE::ExecuteStatus* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_update_, context, request, response, std::move(f));
}

void RPC::Stub::experimental_async::update(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::FT_VDSSE::ExecuteStatus* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_update_, context, request, response, std::move(f));
}

void RPC::Stub::experimental_async::update(::grpc::ClientContext* context, const ::FT_VDSSE::UpdateRequestMessage* request, ::FT_VDSSE::ExecuteStatus* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void RPC::Stub::experimental_async::update(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::FT_VDSSE::ExecuteStatus* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_update_, context, request, response, reactor);
}
...
::grpc::ClientAsyncResponseReader< ::FT_VDSSE::ExecuteStatus>* RPC::Stub::AsyncupdateRaw(::grpc::ClientContext* context, const ::FT_VDSSE::UpdateRequestMessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::FT_VDSSE::ExecuteStatus>::Create(channel_.get(), cq, rpcmethod_update_, context, request, true);
}
...
::grpc::ClientAsyncResponseReader< ::FT_VDSSE::ExecuteStatus>* RPC::Stub::PrepareAsyncupdateRaw(::grpc::ClientContext* context, const ::FT_VDSSE::UpdateRequestMessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::FT_VDSSE::ExecuteStatus>::Create(channel_.get(), cq, rpcmethod_update_, context, request, false);
}
...
void RPC::Stub::experimental_async::update2(::grpc::ClientContext* context, const ::FT_VDSSE::UpdateRequestMessage* request, ::FT_VDSSE::ExecuteStatus* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_update2_, context, request, response, std::move(f));
}

void RPC::Stub::experimental_async::update2(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::FT_VDSSE::ExecuteStatus* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_update2_, context, request, response, std::move(f));
}

void RPC::Stub::experimental_async::update2(::grpc::ClientContext* context, const ::FT_VDSSE::UpdateRequestMessage* request, ::FT_VDSSE::ExecuteStatus* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_update2_, context, request, response, reactor);
}

void RPC::Stub::experimental_async::update2(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::FT_VDSSE::ExecuteStatus* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_update2_, context, request, response, reactor);
}
...
::grpc::ClientAsyncResponseReader< ::FT_VDSSE::ExecuteStatus>* RPC::Stub::Asyncupdate2Raw(::grpc::ClientContext* context, const ::FT_VDSSE::UpdateRequestMessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::FT_VDSSE::ExecuteStatus>::Create(channel_.get(), cq, rpcmethod_update2_, context, request, true);
}
...
::grpc::ClientAsyncResponseReader< ::FT_VDSSE::ExecuteStatus>* RPC::Stub::PrepareAsyncupdate2Raw(::grpc::ClientContext* context, const ::FT_VDSSE::UpdateRequestMessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::FT_VDSSE::ExecuteStatus>::Create(channel_.get(), cq, rpcmethod_update2_, context, request, false);
}
...
::grpc::ClientWriter< ::FT_VDSSE::UpdateRequestMessage>* RPC::Stub::batch_updateRaw(::grpc::ClientContext* context, ::FT_VDSSE::ExecuteStatus* response) {
  return ::grpc_impl::internal::ClientWriterFactory< ::FT_VDSSE::UpdateRequestMessage>::Create(channel_.get(), rpcmethod_batch_update_, context, response);
}

void RPC::Stub::experimental_async::batch_update(::grpc::ClientContext* context, ::FT_VDSSE::ExecuteStatus* response, ::grpc::experimental::ClientWriteReactor< ::FT_VDSSE::UpdateRequestMessage>* reactor) {
  ::grpc_impl::internal::ClientCallbackWriterFactory< ::FT_VDSSE::UpdateRequestMessage>::Create(stub_->channel_.get(), stub_->rpcmethod_batch_update_, context, response, reactor);
}
...
::grpc::ClientAsyncWriter< ::FT_VDSSE::UpdateRequestMessage>* RPC::Stub::Asyncbatch_updateRaw(::grpc::ClientContext* context, ::FT_VDSSE::ExecuteStatus* response, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc_impl::internal::ClientAsyncWriterFactory< ::FT_VDSSE::UpdateRequestMessage>::Create(channel_.get(), cq, rpcmethod_batch_update_, context, response, true, tag);
}
...
::grpc::ClientAsyncWriter< ::FT_VDSSE::UpdateRequestMessage>* RPC::Stub::PrepareAsyncbatch_updateRaw(::grpc::ClientContext* context, ::FT_VDSSE::ExecuteStatus* response, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncWriterFactory< ::FT_VDSSE::UpdateRequestMessage>::Create(channel_.get(), cq, rpcmethod_batch_update_, context, response, false, nullptr);
}
...
void RPC::Stub::experimental_async::SendData(::grpc::ClientContext* context, const ::FT_VDSSE::DataRequest* request, ::FT_VDSSE::DataResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_SendData_, context, request, response, std::move(f));
}

void RPC::Stub::experimental_async::SendData(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::FT_VDSSE::DataResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_SendData_, context, request, response, std::move(f));
}

void RPC::Stub::experimental_async::SendData(::grpc::ClientContext* context, const ::FT_VDSSE::DataRequest* request, ::FT_VDSSE::DataResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void RPC::Stub::experimental_async::SendData(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::FT_VDSSE::DataResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_SendData_, context, request, response, reactor);
}
...
::grpc::ClientAsyncResponseReader< ::FT_VDSSE::DataResponse>* RPC::Stub::AsyncSendDataRaw(::grpc::ClientContext* context, const ::FT_VDSSE::DataRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::FT_VDSSE::DataResponse>::Create(channel_.get(), cq, rpcmethod_SendData_, context, request, true);
}
...
::grpc::ClientAsyncResponseReader< ::FT_VDSSE::DataResponse>* RPC::Stub::PrepareAsyncSendDataRaw(::grpc::ClientContext* context, const ::FT_VDSSE::DataRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::FT_VDSSE::DataResponse>::Create(channel_.get(), cq, rpcmethod_SendData_, context, request, false);
}
