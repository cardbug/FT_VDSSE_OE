...
static void ecall_enclave_process_commands(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_process_commands_args_t* _pargs_in = (enclave_process_commands_args_t*)input_buffer;
    enclave_process_commands_args_t* _pargs_out = (enclave_process_commands_args_t*)output_buffer;
    ...
    if (_pargs_in->input)
        OE_SET_IN_POINTER(input, _pargs_in->input_len, sizeof(char), char*);
    ...
    OE_CHECK_NULL_TERMINATOR(_pargs_in->input, _pargs_in->input_len);

    /* lfence after checks. */
    oe_lfence();

    /* Call user function. */
    _pargs_out->oe_retval = enclave_process_commands(
        (const char*)_pargs_in->input,
        _pargs_in->totalLength);
...
oe_ecall_func_t oe_ecalls_table[] = {
    (oe_ecall_func_t) ecall_enclave_process_commands,
...
oe_result_t host_print_char(const char* str)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    host_print_char_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(host_print_char_args_t));
    if (str)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.str_len, sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(host_print_char_args_t));
    ...
    _pargs_in = (host_print_char_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (str)
    ...
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_host_print_char,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (host_print_char_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t host_print_int(int num)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    host_print_int_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(host_print_int_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(host_print_int_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (host_print_int_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_host_print_int,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (host_print_int_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t send_requests_to_server(
    DataElement* data,
    size_t in_size)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    send_requests_to_server_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.data = (DataElement*)data;
    _args.in_size = in_size;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(send_requests_to_server_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(send_requests_to_server_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (send_requests_to_server_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_send_requests_to_server,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (send_requests_to_server_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t search_server(
    SearchResult* _retval,
    SearchParameters* params)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    search_server_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.params = (SearchParameters*)params;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(search_server_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(search_server_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (search_server_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_search_server,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (search_server_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t send_renew_to_server(DataElement* requests)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    send_renew_to_server_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.requests = (DataElement*)requests;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(send_renew_to_server_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(send_renew_to_server_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (send_renew_to_server_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_send_renew_to_server,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (send_renew_to_server_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_oe_sgx_log_backtrace_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    tdx_quote_collateral_t* collateral)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_oe_get_tdx_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t* p_supplemental_data_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             helloworld_fcn_id_oe_verify_tdx_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
