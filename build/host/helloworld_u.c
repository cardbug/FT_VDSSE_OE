...
enum
{
    helloworld_fcn_id_enclave_process_commands = 0,
...
static const oe_ecall_info_t _helloworld_ecall_info_table[] = 
{
    { "enclave_process_commands" },
...
typedef struct _enclave_process_commands_args_t
{
    ...
    size_t input_len;
    size_t totalLength;
} enclave_process_commands_args_t;
...
oe_result_t helloworld_enclave_process_commands(
    ...
    size_t totalLength)
{
    ...
    /* Marshalling struct. */
    enclave_process_commands_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.input_len = (input) ? (oe_strlen(input) + 1) : 0;
    _args.totalLength = totalLength;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_process_commands_args_t));
    if (input)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.input_len, sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_process_commands_args_t));
    ...
    _pargs_in = (enclave_process_commands_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (input)
        OE_WRITE_IN_PARAM(input, _args.input_len, sizeof(char), char*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _helloworld_ecall_info_table[helloworld_fcn_id_enclave_process_commands].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (enclave_process_commands_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(helloworld_enclave_process_commands, enclave_process_commands);
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _helloworld_ecall_info_table[helloworld_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(helloworld_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t helloworld_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _helloworld_ecall_info_table[helloworld_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(helloworld_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t helloworld_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _helloworld_ecall_info_table[helloworld_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(helloworld_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t helloworld_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _helloworld_ecall_info_table[helloworld_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(helloworld_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t helloworld_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _helloworld_ecall_info_table[helloworld_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(helloworld_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);

/**** Untrusted function IDs. ****/
enum
{
    helloworld_fcn_id_host_print_char = 0,
    helloworld_fcn_id_host_print_int = 1,
    helloworld_fcn_id_send_requests_to_server = 2,
    helloworld_fcn_id_search_server = 3,
    helloworld_fcn_id_send_renew_to_server = 4,
    helloworld_fcn_id_oe_syscall_epoll_create1_ocall = 5,
    helloworld_fcn_id_oe_syscall_epoll_wait_ocall = 6,
    helloworld_fcn_id_oe_syscall_epoll_wake_ocall = 7,
    helloworld_fcn_id_oe_syscall_epoll_ctl_ocall = 8,
    helloworld_fcn_id_oe_syscall_epoll_close_ocall = 9,
    helloworld_fcn_id_oe_syscall_open_ocall = 10,
    helloworld_fcn_id_oe_syscall_read_ocall = 11,
    helloworld_fcn_id_oe_syscall_write_ocall = 12,
    helloworld_fcn_id_oe_syscall_readv_ocall = 13,
    helloworld_fcn_id_oe_syscall_writev_ocall = 14,
    helloworld_fcn_id_oe_syscall_lseek_ocall = 15,
    helloworld_fcn_id_oe_syscall_pread_ocall = 16,
    helloworld_fcn_id_oe_syscall_pwrite_ocall = 17,
    helloworld_fcn_id_oe_syscall_close_ocall = 18,
    helloworld_fcn_id_oe_syscall_flock_ocall = 19,
    helloworld_fcn_id_oe_syscall_fsync_ocall = 20,
    helloworld_fcn_id_oe_syscall_fdatasync_ocall = 21,
    helloworld_fcn_id_oe_syscall_dup_ocall = 22,
    helloworld_fcn_id_oe_syscall_opendir_ocall = 23,
    helloworld_fcn_id_oe_syscall_readdir_ocall = 24,
    helloworld_fcn_id_oe_syscall_rewinddir_ocall = 25,
    helloworld_fcn_id_oe_syscall_closedir_ocall = 26,
    helloworld_fcn_id_oe_syscall_stat_ocall = 27,
    helloworld_fcn_id_oe_syscall_fstat_ocall = 28,
    helloworld_fcn_id_oe_syscall_access_ocall = 29,
    helloworld_fcn_id_oe_syscall_link_ocall = 30,
    helloworld_fcn_id_oe_syscall_unlink_ocall = 31,
    helloworld_fcn_id_oe_syscall_rename_ocall = 32,
    helloworld_fcn_id_oe_syscall_truncate_ocall = 33,
    helloworld_fcn_id_oe_syscall_ftruncate_ocall = 34,
    helloworld_fcn_id_oe_syscall_mkdir_ocall = 35,
    helloworld_fcn_id_oe_syscall_rmdir_ocall = 36,
    helloworld_fcn_id_oe_syscall_fcntl_ocall = 37,
    helloworld_fcn_id_oe_syscall_ioctl_ocall = 38,
    helloworld_fcn_id_oe_syscall_poll_ocall = 39,
    helloworld_fcn_id_oe_syscall_kill_ocall = 40,
    helloworld_fcn_id_oe_syscall_close_socket_ocall = 41,
    helloworld_fcn_id_oe_syscall_socket_ocall = 42,
    helloworld_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 43,
    helloworld_fcn_id_oe_syscall_socketpair_ocall = 44,
    helloworld_fcn_id_oe_syscall_connect_ocall = 45,
    helloworld_fcn_id_oe_syscall_accept_ocall = 46,
    helloworld_fcn_id_oe_syscall_bind_ocall = 47,
    helloworld_fcn_id_oe_syscall_listen_ocall = 48,
    helloworld_fcn_id_oe_syscall_recvmsg_ocall = 49,
    helloworld_fcn_id_oe_syscall_sendmsg_ocall = 50,
    helloworld_fcn_id_oe_syscall_recv_ocall = 51,
    helloworld_fcn_id_oe_syscall_recvfrom_ocall = 52,
    helloworld_fcn_id_oe_syscall_send_ocall = 53,
    helloworld_fcn_id_oe_syscall_sendto_ocall = 54,
    helloworld_fcn_id_oe_syscall_recvv_ocall = 55,
    helloworld_fcn_id_oe_syscall_sendv_ocall = 56,
    helloworld_fcn_id_oe_syscall_shutdown_ocall = 57,
    helloworld_fcn_id_oe_syscall_setsockopt_ocall = 58,
    helloworld_fcn_id_oe_syscall_getsockopt_ocall = 59,
    helloworld_fcn_id_oe_syscall_getsockname_ocall = 60,
    helloworld_fcn_id_oe_syscall_getpeername_ocall = 61,
    helloworld_fcn_id_oe_syscall_getaddrinfo_open_ocall = 62,
    helloworld_fcn_id_oe_syscall_getaddrinfo_read_ocall = 63,
    helloworld_fcn_id_oe_syscall_getaddrinfo_close_ocall = 64,
    helloworld_fcn_id_oe_syscall_getnameinfo_ocall = 65,
    helloworld_fcn_id_oe_syscall_nanosleep_ocall = 66,
    helloworld_fcn_id_oe_syscall_clock_nanosleep_ocall = 67,
    helloworld_fcn_id_oe_syscall_getpid_ocall = 68,
    helloworld_fcn_id_oe_syscall_getppid_ocall = 69,
    helloworld_fcn_id_oe_syscall_getpgrp_ocall = 70,
    helloworld_fcn_id_oe_syscall_getuid_ocall = 71,
    helloworld_fcn_id_oe_syscall_geteuid_ocall = 72,
    helloworld_fcn_id_oe_syscall_getgid_ocall = 73,
    helloworld_fcn_id_oe_syscall_getegid_ocall = 74,
    helloworld_fcn_id_oe_syscall_getpgid_ocall = 75,
    helloworld_fcn_id_oe_syscall_getgroups_ocall = 76,
    helloworld_fcn_id_oe_syscall_uname_ocall = 77,
    helloworld_fcn_id_oe_get_supported_attester_format_ids_ocall = 78,
    helloworld_fcn_id_oe_get_qetarget_info_ocall = 79,
    helloworld_fcn_id_oe_get_quote_ocall = 80,
    helloworld_fcn_id_oe_get_quote_verification_collateral_ocall = 81,
    helloworld_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 82,
    helloworld_fcn_id_oe_verify_quote_ocall = 83,
    helloworld_fcn_id_oe_sgx_get_cpuid_table_ocall = 84,
    helloworld_fcn_id_oe_sgx_backtrace_symbols_ocall = 85,
    helloworld_fcn_id_oe_sgx_log_backtrace_ocall = 86,
    helloworld_fcn_id_oe_sgx_thread_wake_wait_ocall = 87,
    helloworld_fcn_id_oe_sgx_wake_switchless_worker_ocall = 88,
    helloworld_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 89,
    helloworld_fcn_id_oe_get_tdx_quote_verification_collateral_ocall = 90,
    helloworld_fcn_id_oe_verify_tdx_quote_ocall = 91,
    helloworld_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

/**** OCALL marshalling structs. ****/
typedef struct _host_print_char_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    char* str;
    size_t str_len;
} host_print_char_args_t;

typedef struct _host_print_int_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int num;
} host_print_int_args_t;

typedef struct _send_requests_to_server_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    DataElement* data;
    size_t in_size;
} send_requests_to_server_args_t;

typedef struct _search_server_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    SearchResult oe_retval;
    SearchParameters* params;
} search_server_args_t;

typedef struct _send_renew_to_server_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    DataElement* requests;
} send_renew_to_server_args_t;
...
static void ocall_host_print_char(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    host_print_char_args_t* _pargs_in = (host_print_char_args_t*)input_buffer;
    host_print_char_args_t* _pargs_out = (host_print_char_args_t*)output_buffer;
...
static void ocall_host_print_int(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    host_print_int_args_t* _pargs_in = (host_print_int_args_t*)input_buffer;
    host_print_int_args_t* _pargs_out = (host_print_int_args_t*)output_buffer;
...
static void ocall_send_requests_to_server(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    send_requests_to_server_args_t* _pargs_in = (send_requests_to_server_args_t*)input_buffer;
    send_requests_to_server_args_t* _pargs_out = (send_requests_to_server_args_t*)output_buffer;
...
static void ocall_search_server(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    search_server_args_t* _pargs_in = (search_server_args_t*)input_buffer;
    search_server_args_t* _pargs_out = (search_server_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = search_server(
        _pargs_in->params);
...
static void ocall_send_renew_to_server(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    send_renew_to_server_args_t* _pargs_in = (send_renew_to_server_args_t*)input_buffer;
    send_renew_to_server_args_t* _pargs_out = (send_renew_to_server_args_t*)output_buffer;
...
static oe_ocall_func_t _helloworld_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_host_print_char,
    (oe_ocall_func_t) ocall_host_print_int,
    (oe_ocall_func_t) ocall_send_requests_to_server,
    (oe_ocall_func_t) ocall_search_server,
    (oe_ocall_func_t) ocall_send_renew_to_server,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _helloworld_ocall_function_table,
               92,
               _helloworld_ecall_info_table,
                6,
               enclave);
}
